...
Выбранный target задаёт default output path и rendering. Cursor, Codex и OpenCode делят family `AGENTS.md` (last-writer-wins на вызов); Claude — `CLAUDE.md`. Неизвестные флаги отвергаются.

...
Вы описываете, какие skills, инструкции, агенты и MCP-серверы нужны проекту. bapm разрешает зависимости, фиксирует версии в lock-файле и раскладывает их туда, где их подхватит редактор — сегодня runtime **cursor-only** (через `@bapm/integration-cursor`).

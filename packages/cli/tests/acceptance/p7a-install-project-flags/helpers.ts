/**
 * p7a-install-project-flags acceptance helpers (CLI).
 */
import {
  existsSync,
  mkdirSync,
...
export { formatInstallHelp, parseInstallArgs, runCli };

export type TempProject = { cwd: string; cleanup: () => void };

export function createTempProject(prefix = "bapm-p7a-cli-"): TempProject {
...
/** Run CLI with isolated env; always clears host CI unless overlay sets it. */

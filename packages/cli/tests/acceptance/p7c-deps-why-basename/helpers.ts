/**
 * p7c-deps-why-basename acceptance helpers (CLI).
 */
import {
  existsSync,
  mkdirSync,
...
export function createTempProject(prefix = "bapm-p7c-cli-"): TempProject {
...
/** P6f transitive lock (exact name / repo_url regressions). */

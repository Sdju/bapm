/**
 * p7b-outdated-machine-output acceptance helpers (CLI).
 */
...
export { formatOutdatedHelp, parseOutdatedArgs, runCli };

export type TempProject = { cwd: string; cleanup: () => void };

export function createTempProject(prefix = "bapm-p7b-cli-"): TempProject {

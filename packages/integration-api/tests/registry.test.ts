/**
 * @b-apm/integration-api package identity and registry contracts.
 */
...
describe("@b-apm/integration-api package", () => {
  test("package is @b-apm/integration-api with vite-plus scripts", () => {
    ...
    expect(pkg.name).toBe("@b-apm/integration-api");

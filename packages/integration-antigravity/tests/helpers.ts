/**
 * Shared helpers for integration-antigravity-runtime acceptance suite.
 */
...
export function loadAntigravityIntegration(): BapmIntegration {
  if (createIntegration !== createAntigravityIntegration) {
    throw new Error("createIntegration must alias createAntigravityIntegration");
  }
  return createAntigravityIntegration();
}

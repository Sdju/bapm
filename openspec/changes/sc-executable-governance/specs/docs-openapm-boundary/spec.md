...
- **THEN** residual §10 security-depth deferrals (host-class/auth and soft zip container vs tar.gz, or equivalent accurate wording) MUST be disclosed without claiming sc-004 active and without framing claimed user-local approve as wholly OOS

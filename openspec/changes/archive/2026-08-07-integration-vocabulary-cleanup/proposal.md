...
Affected areas include `@b-apm/integration-api` exports and consumers in core, CLI, concrete integrations, tests, active OpenSpec specifications, and live README/docs references. Historical OpenSpec archives and their legacy vocabulary are explicitly out of scope for deletion or rewriting.

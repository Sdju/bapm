...
- **`@bapm/core`:** public symbols for create-minimal-manifest / validate-on-write, pack/unpack zip, secret patterns, checkReleaseTag; Manifest write hardened

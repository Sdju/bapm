...
- **THEN** residual §10 security-depth deferrals (host-class/auth and/or approve/deny UX, soft zip container vs tar.gz, or equivalent accurate wording) MUST be disclosed without claiming sc-004 active

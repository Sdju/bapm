...
| req-mf-022 | MUST | 4.3.2 | consumer | active | packages/core/tests/acceptance/deps-object-skills-targets-subset/install-subset.test.ts (empty skill-subset / stale skill pin diagnostic, req-mf-022); packages/core/tests/spec-conformance/seed-oracles.test.ts; packages/core/tests/manifest/validate.test.ts · tests/fixtures/spec-conformance/manifest/invalid-missing-name.yml; tests/fixtures/spec-conformance/manifest/invalid-no-source-key.yml; tests/fixtures/spec-conformance/manifest/invalid-source-kind.yml; tests/fixtures/spec-conformance/manifest/invalid-registry-scheme.yml; tests/fixtures/spec-conformance/manifest/invalid-registries-typo.yml |
...
| req-mf-024 | MUST | 4.3.2 | consumer | active | packages/core/tests/acceptance/deps-object-skills-targets-subset/identity-merge.test.ts (registry id: object-form serialize + refuse git-shaped rewrite, req-mf-024); packages/core/src/modules/Manifest/mergeApmDependency.ts |
